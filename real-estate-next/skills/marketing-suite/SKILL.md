---
name: real-estate-next/marketing-suite
...
- `~~real-estate-next/lead-management` - For managing interest generated by marketing.
- `~~real-estate-next/property-analyst` - For ensuring the marketing price aligns with appraisal.
- `~~real-estate-next/compliance-closer` - For final REA check before go-live.
